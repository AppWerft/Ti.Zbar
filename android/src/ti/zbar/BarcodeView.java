...
public class BarcodeView extends TiUIView {
	...
	private static final int ALL_BARCODE_SYMBOLS[] = { Symbol.EAN8,
			Symbol.EAN13, Symbol.UPCA, Symbol.UPCE, Symbol.ISBN10,
			Symbol.ISBN13, Symbol.I25, Symbol.DATABAR, Symbol.DATABAR_EXP,
			Symbol.PDF417, Symbol.CODE39, Symbol.CODE93, Symbol.CODE128,
			Symbol.CODABAR, };
	...
	private URL getImageURLPath(BarcodeInputArgs args) {
		...
		if (imageName != null) {
			url = getClass().getResource(
					"/assets/Resources/modules/com.acktie.mobile.android.barcode/"
							+ imageName);
		} else {
