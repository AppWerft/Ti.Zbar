...
/**
 * Immutable container for decoded result symbols associated with an image or a
 * composite symbol.
 */
public class Symbol {
	/** No symbol decoded. */
	...
	/**
	 * Retrieve a symbol confidence metric. Quality is an unscaled, relative
	 * quantity: larger values are better than smaller values, where "large" and
	 * "small" are application dependent.
	 */
